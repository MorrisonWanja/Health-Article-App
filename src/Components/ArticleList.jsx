...
function ArticleList() {
  ...
  const arts = articles.map((article, index) =>
    <ArticleItem key={index} name={article.name} title={article.title} image={article.image} description={article.description} content={article.content} id={article.id} author={article.author} deleteArticle={deleteArticle} onUpdateArticle={handleUpdate} />
  );
